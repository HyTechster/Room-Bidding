        ...
        <div class="min-h-screen flex flex-col">
            ...
            <header class="w-full">
                <div class="max-w-5xl mx-auto px-6 py-5 flex items-center justify-between">
                    <span class="font-semibold text-lg">{{ config('app.name', 'Room Bidding') }}</span>
            ...
            <main class="flex-1">
                <section class="max-w-3xl mx-auto px-6 pt-12 pb-8 text-center">
                    ...
                    <div class="mt-8 flex items-center justify-center gap-3">
                        <a href="{{ route('tool') }}"
                           class="px-6 py-3 rounded-lg bg-indigo-600 text-white text-sm font-medium hover:bg-indigo-700">
                            Launch the tool
                        </a>
                ...
                <section class="max-w-4xl mx-auto px-6 py-10">
                    ...
                    <ol class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <li class="bg-white rounded-lg border border-gray-100 p-5">
                            <div class="text-indigo-600 font-semibold mb-1">4 · See who pays what</div>
